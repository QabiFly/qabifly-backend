...
ALLOWED_HOSTS = env.list("ALLOWED_HOSTS", default=["localhost,qabifly.vps.qalbconverfy.in,https://qabifly.edgeone.app,qabifly.edgeone.app,http://127.0.0.1:7700,http://localhost:7700"])
...
# ─── Databases ────────────────────────────────────────────────────────────────
# PostgreSQL handles all relational, financial, and transactional data.
# MongoDB is accessed directly via PyMongo/MongoEngine in relevant apps.
# Django ORM routes only to PostgreSQL.
...
# MongoDB connection settings — used directly by apps that need it (iot, gis, support, videos)
MONGODB = {
...
# ─── Email — Self-hosted SMTP, no third-party provider SDK ────────────────────

EMAIL_BACKEND = "django.core.mail.backends.smtp.EmailBackend"
EMAIL_HOST = env("EMAIL_HOST", default="mail.qalbconverfy.in")
EMAIL_PORT = env.int("EMAIL_PORT", default=587)
EMAIL_USE_TLS = env.bool("EMAIL_USE_TLS", default=True)
EMAIL_HOST_USER = env("EMAIL_HOST_USER", default="noreply@qalbconverfy.in")
EMAIL_HOST_PASSWORD = env("EMAIL_HOST_PASSWORD", default="")
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="QabiFly <noreply@qalbconverfy.in>")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "QabiFly API",
    "DESCRIPTION": "Hyperlocal e-commerce platform for rural India — Reoti Block, Ballia UP",
    "VERSION": "1.0.0",
