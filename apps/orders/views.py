...
from core.permissions import IsShopkeeper, IsDeliveryBoy
...
class VerifyDeliveryOTPView(APIView):
    ...
    def post(self, request, order_number):
        try:
            ...
            return error_response(
                message="Order not found or not in PICKED state.",
                status_code=404,
            )
        ...
        try:
            ...
            logger.warning(f"Payment split trigger failed: {e}")
